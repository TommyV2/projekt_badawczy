...
# !!! Main.UserApp is configured as an alias for Main.JuliaGenie and you might encounter it in some tests
using Main.JuliaGenie, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuliaGenie tests" begin
  @includetests ARGS
end
